...
class Tree234
{
    private int sortedArrayIndex = 0;
    ...
    private void inOrderTraverse(Node currentNode) {
        if(currentNode.isLeaf()) { // Base case
            ...
            for(int i = 0; i < currentNode.getNumItems(); i++) {
                sortedArray[sortedArrayIndex++] = currentNode.getItem(i).dData;
            }
            return;
        } else {
...
class Tree234App
{
    public static void main(String[] args) throws IOException {
        ...
        long[] array = {90, 60, 45, 120, 30, 70, 102};
        System.out.println(Arrays.toString(theTree.sortArray(array)));
    }
